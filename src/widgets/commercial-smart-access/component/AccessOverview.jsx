...
function AccessOverview({ data = null }) {
  ...
  const chartData = [
    {
      name: "Card Entry",
      value: safeNumber(finalData.card_entry),
      color: "#329DFF",
    },
    {
      name: "Mobile Entry",
      value: safeNumber(finalData.mobile_entry),
      color: "#8B5CF6",
    },
    {
      name: "Card Exit",
      value: safeNumber(finalData.card_exit),
      color: "#B1D2F0",
    },
    {
      name: "Mobile Exit",
      value: safeNumber(finalData.mobile_exit),
      color: "#DACBFB",
    },
  ];
